...
export class Game {
    ...
    constructor() {
        ...
        // Música de lobby al iniciar (se activa con el primer gesto del usuario)
    ...
    // ── Muestra el mapa y luego arranca el combate ───────────────────────────
    ...
    _startNextCombat(level) {
        ...
        // startCombat ya llama a audio.playBattleMusic() internamente
